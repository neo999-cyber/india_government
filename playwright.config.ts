...
export default defineConfig({
  ...
  projects: [
    {
      name: 'desktop',
      testMatch: /(search-count|target-size|allpages|rail|chart-labels|overview-state|atlas-modes|keyboard-interactions|navigation-ia|reading-prefs|seams|carousel|compare-journeys|concept-explainers|pictures)\.spec\.ts/,
